...
- test_time with unit of second
- potential with unit of volt
...
- unix_time with unit of second (see `epoch_time_utc` in the harmonized raw spec), which for example supports sorting of testdata coming from different files
